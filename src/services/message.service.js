...
export const createMessage = async(data)=>{
    ...
    if(!newMessage){
        throw createHttpError.BadRequest("New Message doesn't created.");
    }
    return newMessage;
}
...
export const populateMessage=async(id)=>{
    ...
    if(!msg){
        throw createHttpError.BadRequest("msg is not created.");
    }
    return msg;
};
...
export const getConvoMessages=async(convo_id)=>{
    ...
    if(!messages){
        throw createHttpError.BadRequest("Cann't get your messages.");
    }
    return messages;
}